...
class Institute extends \Application\Entity\Institute implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'institudeAutoId', 'emailId', 'emailIdTwo', 'phoneNumber', 'phoneNumberTwo', 'phoneNumberThree', 'country', 'pincode', 'enabled', 'updatedOn', 'createdOn');
        }
    ...
    public function setinstitudeAutoId($institudeAutoId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setinstitudeAutoId', array($institudeAutoId));

        return parent::setinstitudeAutoId($institudeAutoId);
    }
